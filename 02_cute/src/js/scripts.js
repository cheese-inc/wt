$(function(){
  ...
  $(window).on('load', function() {
    ...
    if (window.matchMedia('(max-width:544px)').matches) {
      ...
      // PCの処理
      sr.reveal('.bridegroom', { easing: 'ease', origin: 'top', distance: '45%', duration: 1000 , scale: 1.0, delay: 200, opacity: 0, right: 0, viewFactor: 0.8,});
      sr.reveal('.bride', { easing: 'ease', origin: 'bottom', distance: '45%', duration: 1000 , scale: 1.0, delay: 200 ,opacity: 0, right: 0, viewFactor: 0.8,});
