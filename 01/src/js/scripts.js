$(function(){
  ...
  $(window).on('load', function() {
    ...
    if (window.matchMedia('(max-width:544px)').matches) {
      ...
      // PCの処理
      sr.reveal('.bridegroom', { easing: 'ease', origin: 'right', distance: '135%', duration: 1000 , scale: 1.0, delay: 200, opacity: 1, right: 0, viewFactor: 0.8,});
      sr.reveal('.bride', { easing: 'ease', origin: 'left', distance: '135%', duration: 1000 , scale: 1.0, delay: 200 ,opacity: 1, right: 0, viewFactor: 0.8,});
