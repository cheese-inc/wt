        ...
        markup: function () {
            ...
            var html = [
                '<dl class="item item-dd days">',
                    '<dd class="dd"></dd>',
                    '<dt class="label label-dd">', this.options.label_dd, '</dt>',
                '</dl>',
                ...
                '<dl class="item item-hh hours">',
                    '<dd>',
                        ...
                        '<span class="hh-2"></span>',
                    '</dd>',
                    '<dt class="label label-hh">', this.options.label_hh, '</dt>',
                '</dl>',
                ...
                '<dl class="item item-mm minutes">',
                    '<dd>',
                        ...
                        '<span class="mm-2"></span>',
                    '</dd>',
                    '<dt class="label label-mm">', this.options.label_mm, '</dt>',
                '</dl>',
                '<span class="separator">', this.options.separator, '</span>',
                '<dl class="item item-ss seconds">',
                    '<dd>',
                        ...
                        '<span class="ss-2"></span>',
                    '</dd>',
                    '<dt class="label label-ss">', this.options.label_ss, '</dt>',
                '</dl>'
            ];
