...
(function ($, window, document, undefined) {
    ...
    $.extend(CountDown.prototype, {
        ...
        markup: function () {
            ...
            var html = [
                '<dl class="item item-dd days">',
                    '<dd class="dd"></dd>',
                    '<dt class="label label-dd serif">', this.options.label_dd, '</dt>',
                '</dl>',
                '<dt class="separator separator-dd">', this.options.separator_days, '</dt>',
                '<dl class="item item-hh hours">',
                    '<dd>',
                        '<span class="hh-1"></span>',
                        '<span class="hh-2"></span>',
                    '</dd>',
                    '<dt class="label label-hh serif">', this.options.label_hh, '</dt>',
                '</dl>',
                '<span class="separator">', this.options.separator, '</span>',
                '<dl class="item item-mm minutes">',
                    '<dd>',
                        '<span class="mm-1"></span>',
                        '<span class="mm-2"></span>',
                    '</dd>',
                    '<dt class="label label-mm serif">', this.options.label_mm, '</dt>',
                '</dl>',
                '<span class="separator">', this.options.separator, '</span>',
                '<dl class="item item-ss seconds">',
                    '<dd>',
                        '<span class="ss-1"></span>',
                        '<span class="ss-2"></span>',
                    '</dd>',
                    '<dt class="label label-ss serif">', this.options.label_ss, '</dt>',
                '</dl>'
            ];
